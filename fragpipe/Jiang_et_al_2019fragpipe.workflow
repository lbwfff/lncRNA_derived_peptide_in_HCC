...
database.db-path=/scratch/lb4489/bioindex/2024-09-16-decoys-contam-uniprot_and_liver_relnc_2.fasta.fas
...
fragpipe-config.bin-diann=/scratch/lb4489/fragpipe/fragpipe/tools/diann/1.8.2_beta_8/linux/diann-1.8.1.8
fragpipe-config.bin-python=/home/lb4489/.conda/envs/py3.9/bin/python
fragpipe-config.tools-folder=/scratch/lb4489/fragpipe/fragpipe/lib/../tools
freequant.mz-tol=10
...
phi-report.filter=--sequential --prot 0.01 --picked --group
...
workdir=/scratch/lb4489/project/hcc/iprox/fragpipe/allrun
workflow.input.data-type.im-ms=false
workflow.input.data-type.regular-ms=true
workflow.misc.save-sdrf=true
workflow.ram=400
workflow.threads=119
